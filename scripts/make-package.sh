...
if [ ! -f build/PotreeElevationProfile ] ||  [ ! -f build/PotreeExtractRegion ]; then
  ...
  g++ -std=c++14 -Wall -lbsd -o build/PotreeElevationProfile main_extract_region.o pmath.o PotreeReader.o -lstdc++fs
  g++ -std=c++14 -Wall -lbsd -o build/PotreeExtractRegion main_elevation_profile.o pmath.o PotreeReader.o -lstdc++fs
fi;
